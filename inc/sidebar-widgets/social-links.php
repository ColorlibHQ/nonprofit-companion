...
class Nonprofit_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Nonprofit ] Social Links', 'nonprofit-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'nonprofit-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'nonprofit-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'nonprofit-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'nonprofit-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'nonprofit-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'nonprofit-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'nonprofit-companion'); ?></label>
...
} // Class nonprofit_social_links ends here


// Register and load the widget
function nonprofit_social_links_widget_load() {
	register_widget( 'Nonprofit_social_links' );
}
add_action( 'widgets_init', 'nonprofit_social_links_widget_load' );