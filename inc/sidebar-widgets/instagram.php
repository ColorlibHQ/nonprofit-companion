...
----------------------------------------*/
class nonprofit_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('nonprofit_instagram_photo',esc_html__('[ Nonprofit ] Intagram Photo','nonprofit-companion'),array(
			'description' => esc_html__('Nonprofit Instagram Photo Widget','nonprofit-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'nonprofit-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'nonprofit-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'nonprofit-companion'); ?></label>
...
if(!function_exists('nonprofit_instagram_widgets')):
	function nonprofit_instagram_widgets(){
		register_widget('nonprofit_instagram_photo');
	}
	add_action('widgets_init','nonprofit_instagram_widgets');
endif;
